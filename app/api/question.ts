...
export const createQuestion = async (questionData: { text: string }): Promise<any> => {
    try {
  ...
  export const updateQuestion = async (questionId: number, questionData: any): Promise<any> => {
    try {
      const response = await IFetch<any>(`${QUESTION_ENDPOINT}${questionId}/`, {
        method: 'PUT',
        data: questionData,
